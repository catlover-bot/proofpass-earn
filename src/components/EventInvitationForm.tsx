...
const copy = {
  en: {
    ...
    bulkHelp: "One email per line. You can also paste Name <email@example.com>.",
    bulkPlaceholder: "Aiko Tanaka <aiko@example.com>\nparticipant@example.com",
  ...
  ja: {
    ...
    adding: "追加中...",
    bulkTitle: "まとめて貼り付け",
    bulkHelp: "1行に1メールアドレスを入力します。Name <email@example.com> 形式にも対応しています。",
    bulkPlaceholder: "Aiko Tanaka <aiko@example.com>\nparticipant@example.com",
    addBulk: "招待を追加",
    addingBulk: "招待を追加中..."
  }
