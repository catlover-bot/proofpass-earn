...
export default async function CertificatePage({
  ...
  const copy = {
    en: {
      ...
      sbtExplanation:
        "This approved proof was also recorded on Base Sepolia as an optional non-transferable testnet SBT for pilot verification.",
      network: "Network",
      tokenId: "Record ID",
      ...
      metadataText:
        "This proof has structured metadata for public proof labels and credentials. SBT/NFT records are never issued automatically.",
      sbtUpgradeTitle: "Optional SBT/NFT extension",
      sbtUpgradeEligible:
        "This proof is approved enough for a future optional SBT/NFT extension if the organizer chooses to issue one.",
      sbtUpgradeNeedsApproval:
        "SBT/NFT extension is future optional functionality and requires organizer approval or evidence verification first.",
    ...
    ja: {
      ...
      sbtExplanation:
        "この承認済み証明は、任意の譲渡不可テストネットSBTとしてBase Sepolia上にも記録されています。",
      network: "ネットワーク",
      tokenId: "記録ID",
      ...
      metadataText: "この証明は、公開証明ラベルや資格情報に使える構造化メタデータを持ちます。SBT/NFT記録は自動発行されません。",
      sbtUpgradeTitle: "任意のSBT/NFT拡張",
      sbtUpgradeEligible:
        "この証明は主催者承認以上のため、主催者が選択した場合に将来SBT/NFT化へ拡張できます。",
      sbtUpgradeNeedsApproval:
        "SBT/NFT化は将来の任意拡張であり、先に主催者承認または提出物確認が必要です。",
