...
const copy = {
  en: {
    ...
    subtitle: "Proof Card for event activity",
    ...
    advanced: "SBT/NFT extension is optional after approval",
    sbtReady: "SBT EXTENSION",
    proofId: "Proof ID",
