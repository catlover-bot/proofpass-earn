...
const copy = {
  en: {
    title: "PROOFPASS PROOF CARD",
    brand: "PROOFPASS",
    cardType: "PROOF CARD",
    subtitle: "Shareable proof card for event activity",
    participant: "Participant",
    event: "Event",
    type: "Proof type",
    issued: "Issued",
    status: "Status",
    walletFirst: "NO WALLET NEEDED",
    privacy: "Shareable proof page first",
    advanced: "Digital proof storage is optional",
    sbtReady: "DIGITAL PROOF",
    proofId: "Proof ID",
    missingTitle: "Proof image unavailable",
    missingText: "This proof card could not be displayed."
  },
  ja: {
    title: "PROOFPASS PROOF CARD",
    brand: "PROOFPASS",
    cardType: "PROOF CARD",
    subtitle: "イベント活動の共有用証明カード",
    participant: "参加者",
    event: "イベント",
    type: "証明タイプ",
    issued: "発行日",
    status: "状態",
    walletFirst: "ウォレット不要",
    privacy: "まずは共有できる証明ページ",
    advanced: "必要に応じてデジタル証明として保存",
    sbtReady: "デジタル証明",
    proofId: "証明ID",
