...
const copy = {
  en: {
    ...
    intro:
      "A shareable view of proof pages, proof labels, and community activity records. Participant email is not shown.",
    owner: "Participant",
    proofs: "Proof pages",
    ...
    achievementsIntro: "ProofPass uses proof labels for participation, contribution, and activity confirmed by the organizer.",
    proofCard: "Proof page",
  ...
  ja: {
    ...
    title: "公開証明コレクション",
    intro:
      "証明ページ、証明ラベル、コミュニティでの活動記録を共有しやすい形で表示します。参加者メールアドレスは表示されません。",
    owner: "参加者",
    proofs: "証明ページ",
    ...
    achievementsIntro: "ProofPassは参加・貢献・主催者が確認した活動のために、証明ラベルを使います。",
    proofCard: "証明ページ",
    publicName: "公開名",
    issued: "発行",
    checkedIn: "チェックイン",
