...
const copy = {
  en: {
    ...
    intro:
      "A collectible view of public proofs, achievement badges, and community contribution records. Participant email is not shown.",
    ...
    achievementsIntro: "ProofPass uses non-transferable achievement badges for participation and community contribution.",
  ...
  ja: {
    ...
    title: "公開証明コレクション",
    intro:
      "公開証明、達成バッジ、コミュニティ貢献記録をカード形式で表示します。参加者メールアドレスは表示されません。",
    profileKey: "コレクションキー",
    owner: "参加者",
    proofs: "証明カード",
    ...
    achievementsIntro: "ProofPassは参加とコミュニティ貢献のために、譲渡不可の達成バッジを使います。",
