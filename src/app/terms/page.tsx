...
const copy = {
  en: {
    ...
    paragraphs: [
      ...
      "Future digital proof storage, if added, should be optional and limited to confirmed proofs. Personal information should not be included in public technical records."
    ]
  },
  ja: {
    title: "パイロット利用規約",
    ...
    paragraphs: [
      ...
      "将来デジタル証明として保存する機能を追加する場合も、確認済み証明の任意拡張として扱います。個人情報を公開用の技術記録に含めないことが大切です。"
    ]
  }
